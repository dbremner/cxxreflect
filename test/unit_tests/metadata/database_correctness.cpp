...
namespace cxxreflect_test { namespace {
    ...
    CXXREFLECTTEST_REGISTER(metadata_database_fundamental_functionality_test, [](context const& c)
    {
    ...
    #define CXXREFLECTTEST_REGISTERTABLETEST(t)                                       \
        CXXREFLECTTEST_REGISTER(metadata_database_tables_ ## t, [&](context const& c) \
        {                                                                             \
            setup_and_call(verify_ ## t ## _table, c);                                \
        })
    
    CXXREFLECTTEST_REGISTERTABLETEST(assembly);
    CXXREFLECTTEST_REGISTERTABLETEST(assembly_ref);
    CXXREFLECTTEST_REGISTERTABLETEST(class_layout);
    CXXREFLECTTEST_REGISTERTABLETEST(custom_attribute);
    CXXREFLECTTEST_REGISTERTABLETEST(decl_security);
    CXXREFLECTTEST_REGISTERTABLETEST(event);
    CXXREFLECTTEST_REGISTERTABLETEST(exported_type);
    CXXREFLECTTEST_REGISTERTABLETEST(field);
    CXXREFLECTTEST_REGISTERTABLETEST(field_marshal);
    CXXREFLECTTEST_REGISTERTABLETEST(field_rva);
    CXXREFLECTTEST_REGISTERTABLETEST(file);
    CXXREFLECTTEST_REGISTERTABLETEST(generic_param);
    CXXREFLECTTEST_REGISTERTABLETEST(generic_param_constraint);
    CXXREFLECTTEST_REGISTERTABLETEST(impl_map);
    CXXREFLECTTEST_REGISTERTABLETEST(interface_impl);
    CXXREFLECTTEST_REGISTERTABLETEST(manifest_resource);
    CXXREFLECTTEST_REGISTERTABLETEST(member_ref);
    CXXREFLECTTEST_REGISTERTABLETEST(method_def);
    CXXREFLECTTEST_REGISTERTABLETEST(method_impl);
    CXXREFLECTTEST_REGISTERTABLETEST(method_spec);
    CXXREFLECTTEST_REGISTERTABLETEST(module);
    CXXREFLECTTEST_REGISTERTABLETEST(module_ref);
    CXXREFLECTTEST_REGISTERTABLETEST(nested_class);
    CXXREFLECTTEST_REGISTERTABLETEST(param);
    CXXREFLECTTEST_REGISTERTABLETEST(property);
    CXXREFLECTTEST_REGISTERTABLETEST(property_map);
    CXXREFLECTTEST_REGISTERTABLETEST(standalone_sig);
    CXXREFLECTTEST_REGISTERTABLETEST(type_def);
    CXXREFLECTTEST_REGISTERTABLETEST(type_ref);
    CXXREFLECTTEST_REGISTERTABLETEST(type_spec);
