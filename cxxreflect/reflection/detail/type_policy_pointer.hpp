...
#ifndef CXXREFLECT_REFLECTION_DETAIL_TYPE_POLICY_POINTER_HPP_
#define CXXREFLECT_REFLECTION_DETAIL_TYPE_POLICY_POINTER_HPP_

#include "cxxreflect/reflection/detail/type_policy_specialization.hpp"

namespace cxxreflect { namespace reflection { namespace detail {

    /// A base type policy for pointer type specializations (signatures)
    class pointer_type_policy final : public specialization_type_policy
    {
    public:
