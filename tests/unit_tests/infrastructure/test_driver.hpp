...
#ifndef CXXREFLECTTEST_UNITTESTS_INFRASTRUCTURE_TEST_DRIVER_HPP_
#define CXXREFLECTTEST_UNITTESTS_INFRASTRUCTURE_TEST_DRIVER_HPP_
...
namespace cxxreflect_test
{
    ...
    #define CXXREFLECTTEST_REGISTER_NAMED(name, f)                          \
        ...
        public:                                                             \
            TEST_METHOD(                                                    \
                CXXREFLECTTEST_CONCATENATE(                                 \
                    CXXREFLECTTEST_CONCATENATE(CXXREFLECT_PROJECT_NAME, _), \
                    CXXREFLECTTEST_CONCATENATE(name, _)))                   \
            {                                                               \
                ::cxxreflect_test::context c;                               \
                f(c);                                                       \
            }                                                               \
        }
    ...
    #define CXXREFLECTTEST_DEFINE_TEST(name) \
