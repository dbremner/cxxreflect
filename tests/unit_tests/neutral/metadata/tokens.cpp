...
namespace cxxreflect_test {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_uninitialized_state)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_construction)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_static_conversions)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_dynamic_conversions)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_arithmetic)
    {
        // We need a non-null scope pointer to avoid tripping the null checks; we'll never perform
        // indirection through this pointer, so we pick the value -1 arbitrarily.
        cxr::database const* const faux_scope(reinterpret_cast<cxr::database const*>(-1));
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_token_comparability)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_blob_uninitialized_state)
    {
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_blob_construction)
    {
        cxr::database const*     const faux_scope(reinterpret_cast<cxr::database const*>(-1));
        cxr::const_byte_iterator const faux_begin(reinterpret_cast<cxr::const_byte_iterator>(1));
        cxr::const_byte_iterator const faux_end  (reinterpret_cast<cxr::const_byte_iterator>(2));
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_hybrid_uninitialized_state)
    {
        // Using an uninitialized blob should fail on pretty much every operation:
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_hybrid_construction)
    {
        cxr::database const*     const faux_scope(reinterpret_cast<cxr::database const*>(-1));
        cxr::const_byte_iterator const faux_begin(reinterpret_cast<cxr::const_byte_iterator>(1));
        cxr::const_byte_iterator const faux_end  (reinterpret_cast<cxr::const_byte_iterator>(2));
    ...
    CXXREFLECTTEST_DEFINE_TEST(metadata_tokens_hybrid_comparability)
    {
        // We need non-null scope pointers to avoid tripping the null checks; we'll never perform
        // indirection through this pointer, so we pick the values -1 and -2 arbitrarily.
        cxr::database const* const faux_scope_a(reinterpret_cast<cxr::database const*>(-1));
