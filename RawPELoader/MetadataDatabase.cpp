...
#include "RawPELoader/MetadataDatabase.hpp"
...
using PeLoader::Utility::AsInteger;
using PeLoader::Utility::DebugFail;
using PeLoader::Utility::DebugVerify;
using PeLoader::Utility::EnhancedCString;
using PeLoader::Utility::FileHandle;

using PeLoader::Metadata::Database;
using PeLoader::Metadata::ReadException;
using PeLoader::Metadata::TableId;
using PeLoader::Metadata::TableIdSizeArray;
...
int main()
{
    using namespace PeLoader::Metadata;
